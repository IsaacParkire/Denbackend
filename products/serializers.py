...
class MainCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MainCategory
        fields = ['id', 'name', 'slug', 'page', 'description', 'image', 'icon', 'order', 'subcategory_count', 'product_count']
...
class SubCategorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SubCategory
        fields = ['id', 'name', 'slug', 'main_category', 'main_category_name', 'description', 'image', 'icon', 'order', 'product_count']
...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'price', 'original_price', 'discount_percentage', 'primary_image',
            'images',
            'is_featured', 'is_exclusive', 'is_limited_edition', 'is_bestseller', 'is_new_arrival',
            'is_in_stock', 'is_on_sale', 'average_rating', 'review_count'
        ]
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_in_stock', 'is_on_sale', 'is_low_stock', 'meta_title', 'meta_description',
...
class ProductSimpleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = [
            'id', 'name', 'slug', 'category_name', 'price', 'primary_image',
            'is_in_stock'
        ]
