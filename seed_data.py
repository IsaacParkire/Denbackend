...
from products.models import Product, Category as ProductCategory, ProductVariant, ProductImage, Review
from services.models import Service, Category as ServiceCategory, Therapist, ServicePackage, ServiceAddon
...
def create_product_categories():
    ...
    for cat_data in categories_data:
        ...
        if created:            print(f"Created product category: {category.name}")
    ...
    products_data = [
        {
            ...
            'stock_quantity': 25,
            'is_featured': True,
            'tags': 'silk,robe,luxury,intimate'
        },
        {
            ...
            'stock_quantity': 30,
            'is_featured': True,
            'tags': 'lace,teddy,elegant,lingerie'
        },
        {
        ...
        },
        {
            ...
            'stock_quantity': 40,
            'is_featured': True,
            'tags': 'massage,oil,luxury,intimate'
        },
        {
            ...
            'stock_quantity': 20,
            'is_featured': True,
            'tags': 'perfume,french,luxury,fragrance'
        }
    ]
...
if __name__ == '__main__':
        {
            'name': 'Beauty & Wellness Package',
            'category': 'Beauty Services',
            'price': Decimal('250.00'),
            'duration': 180,  # 3 hours
            'description': 'Complete beauty and wellness treatment including massage, skincare, and relaxation.',
        },
    ]
